...
import { Settings, Plus, DollarSign, Download, Shield, AlertTriangle, Users } from 'lucide-react'
...
const Admin = () => {
  ...
  const { isOwner, ticketPrices, rounds, createRound, closeAndDraw, withdrawUSDT, setPrices } = useLottery();
